...
public class OptionSetValueController {
    ...
    private static final String OPTION_SET_VALUE_LIST_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
    ...
    private static final String OPTION_SET_VALUE_MAP_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
    ...
    private static final String STRING_VALUE_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
    ...
    private static final String MDEALER_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
