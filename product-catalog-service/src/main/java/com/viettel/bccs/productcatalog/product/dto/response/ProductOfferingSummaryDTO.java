...
@Schema(description = "Thông tin tóm tắt sản phẩm gói cước (chỉ gồm code, name, productOfferingId)")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class ProductOfferingSummaryDTO implements Serializable {
