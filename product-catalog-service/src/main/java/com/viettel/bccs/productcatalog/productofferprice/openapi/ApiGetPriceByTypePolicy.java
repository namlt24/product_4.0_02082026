...
@Operation(
        ...
        description = "Truy vấn danh sách giá bán thiết bị (PRODUCT_OFFER_PRICE) đang active của 1 sản phẩm"
                + " theo priceTypeId và pricePolicy,"
                + " chỉ lấy bản ghi còn hiệu lực theo ngày hiện tại (EFFECT_DATETIME/EXPIRE_DATETIME)."
                + " Kết quả sắp xếp tăng dần theo giá.")
@ApiResponses({
