...
Chạy từ thư mục `product-catalog-service`:
...
```text
src/main/java/com/viettel/bccs/productcatalog  ->  src/main/java/com/viettel/bccs/payment
src/test/java/com/viettel/bccs/productcatalog  ->  src/test/java/com/viettel/bccs/payment
```

Sau đó thay tất cả `com.viettel.bccs.productcatalog` → `com.viettel.bccs.payment` trong mọi file `.java` và `.yml`.
...
Mọi class trong `com.viettel.bccs.productcatalog` đều là code mẫu. Dùng làm ví dụ, sau đó thay bằng tên và hành vi theo nghiệp vụ.
