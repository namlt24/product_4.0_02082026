...
public class ReasonController {
    ...
    private static final String REASON_SINGLE_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
    ...
    private static final String CHECK_ATT_REASON_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
    ...
    private static final String REASON_DTO_LIST_EXAMPLE = """
            {
              "code": "SUCCESS",
              "message": "Thành công",
