...
public class PackageOfferService {
    ...
    @Cacheable(value = "packageOfferCache", key = "'BY_PROD_PACK_TYPE_IDS:' + T(String).join(',', "
    ...
    public Map<Long, List<PackageOfferDTO>> getPackageOfferByListProdPackTypeIds(List<Long> prodPackTypeIds) {
        ...
        Map<Long, List<PackageOfferEntity>> entityMap = 
                repository.getPackageOfferByListProdPackTypeIds(prodPackTypeIds);
