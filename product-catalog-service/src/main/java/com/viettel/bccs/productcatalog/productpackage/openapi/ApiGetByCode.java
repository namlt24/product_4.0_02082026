...
@Operation(
        ...
        description = "Truy vấn thông tin gói sản phẩm (product package) theo mã gói. Trả về danh sách vì một mã gói"
                + " có thể map với nhiều bản ghi (theo telecomServiceId khác nhau)."
                + " Chỉ trả về bản ghi có `status = 1`."
)
@ApiResponses({
