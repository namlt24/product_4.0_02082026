...
@Operation(operationId = "getProductPackageFeeByProductPackageIdAndStatus",
    summary = "Lấy danh sách phí theo ID gói sản phẩm và trạng thái",
...
public @interface ApiGetByProductPackageIdAndStatus {
}
